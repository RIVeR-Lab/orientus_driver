...
public:
  OrientusNode(ros::NodeHandle nh, ros::NodeHandle pnh)
    ...
    pnh_.param("port", port_name, std::string("/dev/ttyUSB0"));
    ...
    packet_periods_packet.packet_periods[0].packet_id = packet_id_status;
    packet_periods_packet.packet_periods[0].period = 100; // 10 Hz
    packet_periods_packet.packet_periods[1].packet_id = packet_id_quaternion_orientation_standard_deviation;
    packet_periods_packet.packet_periods[1].period = 20; // 50 Hz
    packet_periods_packet.packet_periods[2].packet_id = packet_id_quaternion_orientation;
    packet_periods_packet.packet_periods[2].period = 20; // 50 Hz
    packet_periods_packet.packet_periods[3].packet_id = packet_id_acceleration;
    packet_periods_packet.packet_periods[3].period = 20; // 50 Hz
    packet_periods_packet.packet_periods[4].packet_id = packet_id_angular_velocity;
